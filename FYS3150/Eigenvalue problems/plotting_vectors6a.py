...
navn_tekst = np.array(['vectors/eigenvector0.txt', 'vectors/eigenvector1.txt','vectors/eigenvector2.txt'])
navn_tekst_anal = np.array(['vectors/eigenvectoranal0.txt', 'vectors/eigenvectoranal1.txt','vectors/eigenvectoranal2.txt'])
...
plt.title("Three lowest eigenvectors for buckling beam problem with n = 10")
plt.xlabel("$\hat{x}$")
plt.ylabel("$ u(\hat{x}$)")
plt.legend(prop={'size': 8})
plt.savefig("Plot for the three smallest eigenvalues_n10.pdf")
